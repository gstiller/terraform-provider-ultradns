		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_sb", "port", "55"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_sb", "response.0.fail", "fail"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_sb", "run_limit.0.fail", "5"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					acctest.TestAccCheckProbeResourceExists("data.ultradns_probe_dns.data_dns_tc", sdkprobe.TCP),
					...
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "port", "56"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "response.0.warning", "warn"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "response.0.critical", "critical_warning"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "response.0.fail", "failure"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "run_limit.0.warning", "11"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "run_limit.0.critical", "12"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "run_limit.0.fail", "13"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "avg_run_limit.0.warning", "14"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "avg_run_limit.0.critical", "15"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_tc", "avg_run_limit.0.fail", "16"),
				),
			},
		},
	}
